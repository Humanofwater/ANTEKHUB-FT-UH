// File: src/routes/metode_pembayaran.routes.js
// Tujuan: Routing CRUD untuk master "MetodePembayaran" (gaya mengikuti bangsa.routes)

const express = require('express');
const ctrl = require('../controllers/metode_pembayaran.controller');
const saluranPembayaranCtrl = require('../controllers/saluran_pembayaran.controller');
...
// READ ALL BY METODE PEMBAYARAN
router.get(
  '/:metode_uuid/saluran-pembayaran',
  saluranPembayaranCtrl.getAllByMetodeUuid
);
// READ ONE
