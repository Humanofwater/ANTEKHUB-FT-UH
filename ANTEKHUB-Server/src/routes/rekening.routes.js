// File: src/routes/rekening.routes.js
// Tujuan: Routing CRUD untuk master "Rekening" (gaya mengikuti provinsi.routes)

const express = require('express');
const ctrl = require('../controllers/rekening.controller');
...
// READ by Bank UUID (scoped list) — analog "provinsi by bangsa uuid"
router.get('/by-bank/:bank_uuid', ctrl.getAllByBankUuid);
