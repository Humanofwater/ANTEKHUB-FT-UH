// File: src/routes/jenis_institusi.routes.js
// Tujuan: Routing CRUD untuk master "JenisInstitusi" (gaya mengikuti bangsa.routes)

const express = require('express');
const ctrl = require('../controllers/jenis_institusi.controller');
